...
public class MemoListPreference {
	...
	public String getLanguageFromCode() {  return m_languageFromCode; }
	public void setLanguageFromCode(String languageFromCode) { m_languageFromCode = languageFromCode; }

	public String getLanguageToCode() {  return m_languageToCode; }
	public void setLanguageToCode(String languageToCode) { m_languageToCode = languageToCode; }
