...
public class LanguageSpinner extends Spinner implements AdapterView.OnItemSelectedListener {
	...
	private final static String LanguagePreferences = "LanguagePreferences";
	...
	public void bindData() {
		...
		String languagePreferences = m_preferences.get(LanguagePreferences);
		ArrayList<LanguageView> all = new ArrayList<LanguageView>();
	...
	public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
		...
		m_preferences.set(LanguagePreferences, languagePreferences);
	}
