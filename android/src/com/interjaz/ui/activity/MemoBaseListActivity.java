...
public class MemoBaseListActivity extends GestureActivity {
	...
	public boolean onContextItemSelected(MenuItem item) {
		...
		final String memoBaseId = m_lstAdapter.getItem(m_selectedItemPosition).getMemoBaseInfo()
				.getMemoBase().getMemoBaseId();
		Intent intent;
